...
class List(base.ListCommand):
  ...
  def Args(parser):
    ...
    # The default list format is a table including name, short_name,
    # description and semantics. For example:
    #
    # NAME          SHORT_NAME  DESCRIPTION    SEMANTICS
    # tagKeys/1234  env         Environment    ENV
    # tagKeys/5678  costCenter  Cost Center
    parser.display_info.AddFormat(
        "table(name:sort=1, short_name, description, semantics)"
    )
